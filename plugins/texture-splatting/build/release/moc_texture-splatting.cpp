/****************************************************************************
** Meta object code from reading C++ file 'texture-splatting.h'
**
...
#error "The header file 'texture-splatting.h' doesn't include <QObject>."
...
const QMetaObject TextureSplatting::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TextureSplatting.data,
      qt_meta_data_TextureSplatting,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *TextureSplatting::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "BasicPlugin"))
        return static_cast< BasicPlugin*>(const_cast< TextureSplatting*>(this));
