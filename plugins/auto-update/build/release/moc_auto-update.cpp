/****************************************************************************
** Meta object code from reading C++ file 'auto-update.h'
**
...
#error "The header file 'auto-update.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_AutoUpdate_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AutoUpdate_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AutoUpdate_t qt_meta_stringdata_AutoUpdate = {
    {
QT_MOC_LITERAL(0, 0, 10) // "AutoUpdate"
...
void AutoUpdate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject AutoUpdate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AutoUpdate.data,
      qt_meta_data_AutoUpdate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AutoUpdate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AutoUpdate.stringdata0))
        return static_cast<void*>(const_cast< AutoUpdate*>(this));
    if (!strcmp(_clname, "BasicPlugin"))
        return static_cast< BasicPlugin*>(const_cast< AutoUpdate*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  's',  's',  'N',  'a',  'm',  'e',  0x00,
    0x0a, 0x00, 'A',  'u',  't',  'o',  'U',  'p', 
    'd',  'a',  't',  'e',  ':',  0xa0, 0xa0, 0x00,
...
QT_MOC_EXPORT_PLUGIN(AutoUpdate, AutoUpdate)
