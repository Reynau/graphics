/****************************************************************************
** Meta object code from reading C++ file 'seleccio-obj-teclat.h'
**
...
#error "The header file 'seleccio-obj-teclat.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_SeleccioTeclat_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SeleccioTeclat_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SeleccioTeclat_t qt_meta_stringdata_SeleccioTeclat = {
    {
QT_MOC_LITERAL(0, 0, 14) // "SeleccioTeclat"
...
const QMetaObject SeleccioTeclat::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SeleccioTeclat.data,
      qt_meta_data_SeleccioTeclat,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SeleccioTeclat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SeleccioTeclat.stringdata0))
        return static_cast<void*>(const_cast< SeleccioTeclat*>(this));
    if (!strcmp(_clname, "BasicPlugin"))
        return static_cast< BasicPlugin*>(const_cast< SeleccioTeclat*>(this));
...
static const unsigned char qt_pluginMetaData[] = {
    ...
    'a',  'm',  'e',  0x00, 0x0e, 0x00, 'S',  'e', 
    'l',  'e',  'c',  'c',  'i',  'o',  'T',  'e', 
    'c',  'l',  'a',  't',  '1',  0x00, 0x00, 0x00,
...
QT_MOC_EXPORT_PLUGIN(SeleccioTeclat, SeleccioTeclat)
