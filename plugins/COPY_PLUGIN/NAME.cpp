...
void Framerate::onPluginLoad () {
  ...
  vs->compileSourceFile("/home/xavi/Documents/University/G/viewer/plugins/framerate/show.vert");

  fs = new QOpenGLShader(QOpenGLShader::Fragment, this);
  fs->compileSourceFile("/home/xavi/Documents/University/G/viewer/plugins/framerate/show.frag");
...
void NameClass::drawText (GLWidget &g, string text) {
	g.makeCurrent();
	...
	int x = 15;
	int y = 50;
	painter.drawText(x, y, QString(text)); // text = QString("FPS: %1").arg(fps)
	painter.end();
